...
//        [self addSubview:_collectMailButton];
        ...
        _nameView = [[NSTextView alloc] initWithFrame:CGRectMake(40, 0, 100, 16)];
        _nameView.editable=NO;
        _nameView.selectable=NO;
        _nameView.backgroundColor = [NSColor clearColor];
        [self addSubview:_nameView];
        
        _textView = [[NSTextView alloc] initWithFrame:CGRectMake(140, 0, 400, 16)];
        _textView.editable=NO;
        _textView.selectable=NO;
        _textView.backgroundColor = [NSColor clearColor];
        [self addSubview:_textView];
        
        _timeView = [[NSTextView alloc] initWithFrame:CGRectMake(570, 0, 170, 16)];
